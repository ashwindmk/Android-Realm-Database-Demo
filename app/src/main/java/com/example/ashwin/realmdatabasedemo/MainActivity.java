...
public class MainActivity extends AppCompatActivity {
                ...
                builder.setView(content)
                        ...
                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                book.setId(RealmController.getInstance().getBooks().size() + (int) System.currentTimeMillis());
    ...
    private void setRealmData() {
        ...
        Book book = new Book();
        book.setId(1 + (int) System.currentTimeMillis());
        ...
        book = new Book();
        book.setId(2 + (int) System.currentTimeMillis());
        ...
        book = new Book();
        book.setId(3 + (int) System.currentTimeMillis());
        ...
        book = new Book();
        book.setId(4 + (int) System.currentTimeMillis());
        ...
        book = new Book();
        book.setId(5 + (int) System.currentTimeMillis());
